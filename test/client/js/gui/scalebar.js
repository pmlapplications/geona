...
import {convertToStandardForm} from '../../../../src/js/gui/scalebar.js';
...
describe('client/js/test/gui/scalebar', function() { // todo - probably good to test the race condition fixes here
  ...
  before(function(done) {
    ...
    let config1 = {
      'geonaVariable': 'geonaScalebarTest',
