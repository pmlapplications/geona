...
describe('client/js/test/geona', function() {
  ...
  describe('_saveGeonaState()', function() {
    it('should return the default state for this config', function() {
      // todo - with test_dependencies
    });
    it('should return the updated map state', function() {
      // todo - with test_dependencies
    });
  });

  describe('saveGeonaStateToBrowser()', function() {
    it('should save the default state for this config to the browser local storage', function() {
      // todo - with test_dependencies
    });
    it('should save the updated map state to the browser local storage', function() {
      // todo - with test_dependencies
    });
  });
});
